...
<a name="1.0.0-rc.3"></a>
# [1.0.0-rc.3](https://github.com/Ivans51/android-inventory-agent/compare/1.0.0-rc.2...1.0.0-rc.3) (2018-11-21)
...
* **about:** close link tag on last commit link ([09ba4e0](https://github.com/Ivans51/android-inventory-agent/commit/09ba4e0))
* **alarm:** check if execute the inventory ([e23e5ff](https://github.com/Ivans51/android-inventory-agent/commit/e23e5ff))
* **alarm:** set repeting with interval day ([2b26632](https://github.com/Ivans51/android-inventory-agent/commit/2b26632))
* **alarm:** update alarm repeating time ([920a1bf](https://github.com/Ivans51/android-inventory-agent/commit/920a1bf))
* **anonymous:** add application json on request property ([7d27710](https://github.com/Ivans51/android-inventory-agent/commit/7d27710))
* **apk:** changed version code in manifest ([13d2166](https://github.com/Ivans51/android-inventory-agent/commit/13d2166))
* **build:** implement inventory library 0.8.6 ([d954988](https://github.com/Ivans51/android-inventory-agent/commit/d954988))
* **connection:** add default value to URL ([214cfd6](https://github.com/Ivans51/android-inventory-agent/commit/214cfd6))
* **connection:** allow work on main thread ([7fee1b7](https://github.com/Ivans51/android-inventory-agent/commit/7fee1b7))
* **connection:** return method when the validation is true ([1c1022b](https://github.com/Ivans51/android-inventory-agent/commit/1c1022b))
* **connection:** validated https connection ([166f678](https://github.com/Ivans51/android-inventory-agent/commit/166f678))
* **data:** fix anonymous data summary text ([f1a4467](https://github.com/Ivans51/android-inventory-agent/commit/f1a4467))
* **icon:** shown icon app with API below 26 ([43d7b0c](https://github.com/Ivans51/android-inventory-agent/commit/43d7b0c))
* **inventory:** add log messages ([449c245](https://github.com/Ivans51/android-inventory-agent/commit/449c245))
* **inventory:** catch empty url exception ([3a53517](https://github.com/Ivans51/android-inventory-agent/commit/3a53517))
* **inventory:** validate headers response ([dc978dd](https://github.com/Ivans51/android-inventory-agent/commit/dc978dd))
* **inventory:** validate http response ([7bd2f1f](https://github.com/Ivans51/android-inventory-agent/commit/7bd2f1f))
* **main:** remove request permission ([6e61dd4](https://github.com/Ivans51/android-inventory-agent/commit/6e61dd4))
* **package:** update conventional-github-releaser to version 2.0.0 ([f83cf33](https://github.com/Ivans51/android-inventory-agent/commit/f83cf33))
* **package:** update conventional-github-releaser to version 3.0.0 ([63eb802](https://github.com/Ivans51/android-inventory-agent/commit/63eb802))
* remove modules file created by IntelliJ IDEA ([01d80be](https://github.com/Ivans51/android-inventory-agent/commit/01d80be))
* **permission:** move next screen from main to permission ([19c4538](https://github.com/Ivans51/android-inventory-agent/commit/19c4538))
* **progress:** change behavior progress bar ([255e3c3](https://github.com/Ivans51/android-inventory-agent/commit/255e3c3))
* **schedule:** automatic inventory by default disable ([66e9b08](https://github.com/Ivans51/android-inventory-agent/commit/66e9b08))
* **schedule:** change type schedule to send inventory ([38fe797](https://github.com/Ivans51/android-inventory-agent/commit/38fe797))
* **schedule:** validated if change the schedule ([ce45567](https://github.com/Ivans51/android-inventory-agent/commit/ce45567))
* **share:** implement the inventory library share method ([b474026](https://github.com/Ivans51/android-inventory-agent/commit/b474026))
* **splash:** add postdelayed direct on splash activity ([ecd0881](https://github.com/Ivans51/android-inventory-agent/commit/ecd0881))
* **toolbar:** fix toolbar nullpointerexception ([bf851df](https://github.com/Ivans51/android-inventory-agent/commit/bf851df))
* **ui:** add delay on request permission popup ([e4fade7](https://github.com/Ivans51/android-inventory-agent/commit/e4fade7))


### Features

* **design:** add send anonymous data method ([1f6cd8f](https://github.com/Ivans51/android-inventory-agent/commit/1f6cd8f))
* Add the inventory engine as dependency ([#3](https://github.com/Ivans51/android-inventory-agent/issues/3)) ([a22641d](https://github.com/Ivans51/android-inventory-agent/commit/a22641d))
* **about:** add about screen ([4c98590](https://github.com/Ivans51/android-inventory-agent/commit/4c98590))
* **about:** add html and properties information ([2461095](https://github.com/Ivans51/android-inventory-agent/commit/2461095))
* **about:** add preference about item ([2f86181](https://github.com/Ivans51/android-inventory-agent/commit/2f86181))
* **about:** add toolbar ([c384af7](https://github.com/Ivans51/android-inventory-agent/commit/c384af7))
* **acra:** add acra library ([816c174](https://github.com/Ivans51/android-inventory-agent/commit/816c174))
* **acra:** configuring acra ([47fe507](https://github.com/Ivans51/android-inventory-agent/commit/47fe507))
* **acra:** remove acra resources ([47c4489](https://github.com/Ivans51/android-inventory-agent/commit/47c4489))
* **acra:** set tracepot like server and add aditional setup ([4958fc7](https://github.com/Ivans51/android-inventory-agent/commit/4958fc7))
* **assets:** add graphic resources and translations  ([#16](https://github.com/Ivans51/android-inventory-agent/issues/16)) ([83f0afd](https://github.com/Ivans51/android-inventory-agent/commit/83f0afd))
* **bugsnag:** add custom endpoint ([37f92da](https://github.com/Ivans51/android-inventory-agent/commit/37f92da))
* **bugsnag:** implement basic bugsnag feature ([4ffa59b](https://github.com/Ivans51/android-inventory-agent/commit/4ffa59b))
* **cache:** add long and boolean cache method ([d65afb2](https://github.com/Ivans51/android-inventory-agent/commit/d65afb2))
* **countdown:** check the auto inventory to show the countdown ([b44a47f](https://github.com/Ivans51/android-inventory-agent/commit/b44a47f))
* **design:** add check type item layout for home list ([84fe481](https://github.com/Ivans51/android-inventory-agent/commit/84fe481))
* **design:** add default item layout for home list ([407634c](https://github.com/Ivans51/android-inventory-agent/commit/407634c))
* **design:** add drawer menu adapter ([65ddf88](https://github.com/Ivans51/android-inventory-agent/commit/65ddf88))
* **design:** add drawer menu titles ([b1d4398](https://github.com/Ivans51/android-inventory-agent/commit/b1d4398))
* **design:** add global parameters layout ([f53ba44](https://github.com/Ivans51/android-inventory-agent/commit/f53ba44))
* **design:** add global parameters preference ([268d7f9](https://github.com/Ivans51/android-inventory-agent/commit/268d7f9))
* **design:** add header type item layout for home list ([96e5bf3](https://github.com/Ivans51/android-inventory-agent/commit/96e5bf3))
* **design:** add icons resources ([dc92041](https://github.com/Ivans51/android-inventory-agent/commit/dc92041))
* **design:** add inventory options ([3ae6986](https://github.com/Ivans51/android-inventory-agent/commit/3ae6986))
* **design:** add inventory parameters layout ([1f517a7](https://github.com/Ivans51/android-inventory-agent/commit/1f517a7))
* **design:** add inventory parameters preference ([28dd850](https://github.com/Ivans51/android-inventory-agent/commit/28dd850))
* **design:** add list item drawer layout ([38c21f9](https://github.com/Ivans51/android-inventory-agent/commit/38c21f9))
* **design:** add list on layout ([6b06d36](https://github.com/Ivans51/android-inventory-agent/commit/6b06d36))
* **design:** add main activity ([4703aec](https://github.com/Ivans51/android-inventory-agent/commit/4703aec))
* **design:** add service and options ([550a892](https://github.com/Ivans51/android-inventory-agent/commit/550a892))
* **design:** add text styles ([1a780c9](https://github.com/Ivans51/android-inventory-agent/commit/1a780c9))
* **design:** create home adapter ([70a1bea](https://github.com/Ivans51/android-inventory-agent/commit/70a1bea))
* **design:** create home schema for list ([e9a1f13](https://github.com/Ivans51/android-inventory-agent/commit/e9a1f13))
* **design:** implement about like fragment ([c26b568](https://github.com/Ivans51/android-inventory-agent/commit/c26b568))
* **design:** launch main activity ([63cb23a](https://github.com/Ivans51/android-inventory-agent/commit/63cb23a))
* **design:** request permission to the user ([bcbccae](https://github.com/Ivans51/android-inventory-agent/commit/bcbccae))
* **design:** update design with drawer and toolbar ([4364b4c](https://github.com/Ivans51/android-inventory-agent/commit/4364b4c))
* **design:** update main activity layout ([e7dfa7c](https://github.com/Ivans51/android-inventory-agent/commit/e7dfa7c))
* **easteregg:** add easter egg crash report ([266444b](https://github.com/Ivans51/android-inventory-agent/commit/266444b))
* **help:** add help implementation ([39f2793](https://github.com/Ivans51/android-inventory-agent/commit/39f2793))
* **icon:** add adaptive icon to android oreo ([42e9677](https://github.com/Ivans51/android-inventory-agent/commit/42e9677))
* **inventory:** add count down on the service ([da2e70f](https://github.com/Ivans51/android-inventory-agent/commit/da2e70f))
* **inventory:** add description information on version client ([bf4b793](https://github.com/Ivans51/android-inventory-agent/commit/bf4b793))
* **inventory:** add line separate and background color list ([4fff039](https://github.com/Ivans51/android-inventory-agent/commit/4fff039))
* **inventory:** add progress dialog running inventory ([b418b50](https://github.com/Ivans51/android-inventory-agent/commit/b418b50))
* **inventory:** add tablayout ([23a1c86](https://github.com/Ivans51/android-inventory-agent/commit/23a1c86))
* **inventory:** add viewpager and show info ([3c86a58](https://github.com/Ivans51/android-inventory-agent/commit/3c86a58))
* **inventory:** changed style tab information ([7c10644](https://github.com/Ivans51/android-inventory-agent/commit/7c10644))
* **inventory:** implement count down ([a3224de](https://github.com/Ivans51/android-inventory-agent/commit/a3224de))
* **inventory:** remove header in specific tab ([05e05ca](https://github.com/Ivans51/android-inventory-agent/commit/05e05ca))
* **inventory:** remove tab to empty information ([2d1e55f](https://github.com/Ivans51/android-inventory-agent/commit/2d1e55f))
* **inventory:** send inventory on thread ([6da1a06](https://github.com/Ivans51/android-inventory-agent/commit/6da1a06))
* **inventory:** Send inventory to all servers ([e574109](https://github.com/Ivans51/android-inventory-agent/commit/e574109))
* **language:** add catalan language ([12bb53e](https://github.com/Ivans51/android-inventory-agent/commit/12bb53e))
* **library:** update inventory library ([5186052](https://github.com/Ivans51/android-inventory-agent/commit/5186052))
* **menu:** update inventory icon ([d5ec4af](https://github.com/Ivans51/android-inventory-agent/commit/d5ec4af))
* **notification:** send message to notification bar ([97b19fb](https://github.com/Ivans51/android-inventory-agent/commit/97b19fb))
* **permission:** add request permission screen ([fcce741](https://github.com/Ivans51/android-inventory-agent/commit/fcce741))
* **privacy:** add privacy functionality ([c372bc8](https://github.com/Ivans51/android-inventory-agent/commit/c372bc8))
* **privacy:** add privacy on anonymous data ([faea7e6](https://github.com/Ivans51/android-inventory-agent/commit/faea7e6))
* **servers:** add button and list server activity ([99ca5a0](https://github.com/Ivans51/android-inventory-agent/commit/99ca5a0))
* **servers:** add button close dialog ([d84effd](https://github.com/Ivans51/android-inventory-agent/commit/d84effd))
* **servers:** add tag to time alarm and service ([9a60902](https://github.com/Ivans51/android-inventory-agent/commit/9a60902))
* **servers:** added list view servers ([d9a2ef4](https://github.com/Ivans51/android-inventory-agent/commit/d9a2ef4))
* **servers:** limit size name list server in dialog ([15a93c1](https://github.com/Ivans51/android-inventory-agent/commit/15a93c1))
* **servers:** new dialog to list servers ([9b462f9](https://github.com/Ivans51/android-inventory-agent/commit/9b462f9))
* **servers:** validate empty server and show message ([f0c69ae](https://github.com/Ivans51/android-inventory-agent/commit/f0c69ae))
* **share:** add share button ([f4220e0](https://github.com/Ivans51/android-inventory-agent/commit/f4220e0))
* **show:** add inventory activity and adapter ([45ec95c](https://github.com/Ivans51/android-inventory-agent/commit/45ec95c))
* **tag:** send tag to inventory ([d5a414b](https://github.com/Ivans51/android-inventory-agent/commit/d5a414b))
